...
### Agno SDK Development Pre-Rules

When implementing or modifying anything related to Agno:

- Always search Agno MCP first.

- Never rely solely on pretrained knowledge and model memory.

- Adopt the latest official API from Agno docs.

- Follow official examples preferentially.